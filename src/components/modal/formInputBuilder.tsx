...
function input(field: FormFieldType, FieldsValue: any) {
    return (
        <input
            ...
            className={` ${field.readOnly && 'pointer-events-none'} input-shadow focus:shadow-outline block h-full w-full rounded-sm border border-gray-300 py-2 px-4 text-left text-sm text-gray-900 hover:border-blue-400 focus:border-blue-400`}
        />
    )
}
